...
export class Migration20240423182155_Initial extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "user" ("id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "role_id" varchar(255) not null, "firebase_id" varchar(255) null, "first_name" varchar(100) not null, "last_name" varchar(100) not null, "avatar" text not null, "email" varchar(100) not null, "phone" varchar(20) null, "phone_verified_at" timestamptz null, "password" varchar(255) null, "date_of_birth" date null, "sex" text check ("sex" in (\'male\', \'female\')) null, "role_title" varchar(100) null, "status" text check ("status" in (\'active\', \'inactive\', \'pending\', \'deleted\', \'verified\', \'unverified\', \'approved\', \'unapproved\', \'rejected\', \'accepted\', \'failed\', \'completed\', \'incomplete\', \'blocked\', \'initiated\', \'not_started\')) not null, constraint "user_pkey" primary key ("id"));');
