...
export class Migration20240725005228_Initial extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "user" ("id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "role_id" varchar(255) not null, "firebase_id" varchar(255) null, "first_name" varchar(100) null, "last_name" varchar(100) null, "avatar" text not null, "email" varchar(100) not null, "phone" varchar(20) null, "phone_verified_at" timestamptz null, "password" varchar(255) null, "date_of_birth" date null, "sex" text check ("sex" in (\'male\', \'female\')) null, "role_title" varchar(100) null, "status" text check ("status" in (\'active\', \'inactive\', \'pending\', \'deleted\', \'verified\', \'unverified\', \'approved\', \'unapproved\', \'rejected\', \'accepted\', \'failed\', \'completed\', \'incomplete\', \'blocked\', \'initiated\', \'not_started\', \'paused\', \'stopped\')) not null, constraint "user_pkey" primary key ("id"));');
    ...
    this.addSql('create table "campaign" ("id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "user_id" varchar(255) not null, "name" varchar(255) not null, "description" text null, "demographic" varchar(255) not null, "target_age" int not null, "target_reach" int not null, "budget" int not null, "fee" int not null default 0, "per_interaction_cost" int not null, "asset" varchar(255) not null, "start" timestamptz not null, "end" timestamptz not null, "status" text check ("status" in (\'active\', \'inactive\', \'pending\', \'deleted\', \'verified\', \'unverified\', \'approved\', \'unapproved\', \'rejected\', \'accepted\', \'failed\', \'completed\', \'incomplete\', \'blocked\', \'initiated\', \'not_started\', \'paused\', \'stopped\')) not null, "likes" int not null default 0, "views" int not null default 0, constraint "campaign_pkey" primary key ("id"));');
    ...
    this.addSql('create table "attempt" ("id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "kyc_id" varchar(255) not null, "updated_by_id" varchar(255) null, "status" text check ("status" in (\'active\', \'inactive\', \'pending\', \'deleted\', \'verified\', \'unverified\', \'approved\', \'unapproved\', \'rejected\', \'accepted\', \'failed\', \'completed\', \'incomplete\', \'blocked\', \'initiated\', \'not_started\', \'paused\', \'stopped\')) not null, "level" int not null default 1, "reason" varchar(255) null, "details" jsonb null, constraint "attempt_pkey" primary key ("id"));');

    this.addSql('create table "wallet" ("id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "user_id" varchar(255) null, "balance" int not null default 0, "currency" varchar(255) not null default \'GHS\', "status" text check ("status" in (\'active\', \'inactive\', \'pending\', \'deleted\', \'verified\', \'unverified\', \'approved\', \'unapproved\', \'rejected\', \'accepted\', \'failed\', \'completed\', \'incomplete\', \'blocked\', \'initiated\', \'not_started\', \'paused\', \'stopped\')) not null, constraint "wallet_pkey" primary key ("id"));');
    this.addSql('alter table "wallet" add constraint "wallet_user_id_unique" unique ("user_id");');

    this.addSql('create table "wallet_transaction" ("id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "wallet_id" varchar(255) not null, "payment_id" varchar(255) null, "amount" int not null, "fee" int not null default 0, "before" int not null, "after" int not null, "reference" varchar(255) not null, "link_id" varchar(255) null, "description" varchar(255) null, "type" text check ("type" in (\'DEBIT\', \'CREDIT\', \'REFUND\')) not null, "status" text check ("status" in (\'active\', \'inactive\', \'pending\', \'deleted\', \'verified\', \'unverified\', \'approved\', \'unapproved\', \'rejected\', \'accepted\', \'failed\', \'completed\', \'incomplete\', \'blocked\', \'initiated\', \'not_started\', \'paused\', \'stopped\')) not null, constraint "wallet_transaction_pkey" primary key ("id"));');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "interaction" drop constraint "interaction_user_id_foreign";');
    ...
    this.addSql('alter table "wallet_transaction_change" drop constraint "wallet_transaction_change_updated_by_id_foreign";');
    ...
    this.addSql('alter table "interaction" drop constraint "interaction_campaign_id_foreign";');

    this.addSql('alter table "wallet_transaction" drop constraint "wallet_transaction_wallet_id_foreign";');

    this.addSql('alter table "wallet_transaction_change" drop constraint "wallet_transaction_change_transaction_id_foreign";');
